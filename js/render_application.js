//myApp.controller('userCtrl', ['$scope', function($scope) {
	...
	function UpdateRender(color) {
		...
		var color_selected = parseInt( ("0x" + color), 16);
		...
		alert("current color is:" + $document.window.processing_color );

	};

	//UpdateRender($scope.processing_color);
	UpdateRender(window.reserved_color_variable);
//}]);
