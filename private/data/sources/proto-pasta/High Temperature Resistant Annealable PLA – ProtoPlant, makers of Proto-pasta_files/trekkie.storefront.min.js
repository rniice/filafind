...
h.all(this);var a=this;this.on("initialize",function(b,d){d.initialPageview&&a.page();a._parseQuery(window.location.search)})}var b=window.analytics,f=c("emitter");e=c("facade");var d=c("after"),h=c("bind"),l=c("callback"),k=c("clone"),m=c("./cookie"),q=c("debug"),w=c("defaults"),p=c("each"),u=c("foldl"),v=c("./group"),n=c("is"),A=c("is-meta"),x=c("object").keys,y=c("./memory"),B=c("./normalize"),t=c("event").bind,r=c("./pageDefaults"),E=c("pick"),C=c("prevent"),F=c("querystring"),G=c("object").length,
D=c("./store"),z=c("./user"),H=e.Alias,I=e.Group,J=e.Identify,K=e.Page,L=e.Track;e=g.exports=a;e.cookie=m;e.store=D;e.memory=y;f(a.prototype);a.prototype.use=function(a){a(this);return this};a.prototype.addIntegration=function(a){var b=a.prototype.name;if(!b)throw new TypeError("attempted to add an invalid integration");this.Integrations[b]=a;return this};a.prototype.init=a.prototype.initialize=function(a,b){a=a||{};b=b||{};this._options(b);this._readied=!1;var f=this;p(a,function(b){f.Integrations[b]||
delete a[b]});p(a,function(a,b){var d=new f.Integrations[a](k(b));f.log("initialize %o - %o",a,b);f.add(d)});var h=this._integrations;z.load();v.load();var m=d(G(h),function(){f._readied=!0;f.emit("ready")});p(h,function(a,h){b.initialPageview&&!1===h.options.initialPageview&&(h.page=d(2,h.page));h.analytics=f;h.once("ready",m);h.initialize()});this.initialized=!0;this.emit("initialize",a,b);return this};a.prototype.setAnonymousId=function(a){this.user().anonymousId(a);return this};a.prototype.add=
...
(d=b,b=a,a=v.id());v.identify(a,b);var h=this.normalize({options:d,traits:v.traits(),groupId:v.id()});this._invoke("group",new I(h));this.emit("group",a,b,d);this._callback(f);return this};a.prototype.track=function(a,b,d,f){n.fn(d)&&(f=d,d=null);n.fn(b)&&(f=b,b=d=null);var h=this.options.plan||{},h=h.track||{},m=this.normalize({properties:b,options:d,event:a});if(h=h[a]){this.log("plan %o - %o",a,h);if(!1===h.enabled)return this._callback(f);w(m.integrations,h.integrations||{})}this._invoke("track",
new L(m));this.emit("track",a,b,d);this._callback(f);return this};a.prototype.trackClick=a.prototype.trackLink=function(a,b,d){if(!a)return this;n.element(a)&&(a=[a]);var f=this;p(a,function(a){if(!n.element(a))throw new TypeError("Must pass HTMLElement to `analytics.trackLink`.");t(a,"click",function(h){var m=n.fn(b)?b(a):b,c=n.fn(d)?d(a):d,k=a.getAttribute("href")||a.getAttributeNS("http://www.w3.org/1999/xlink","href")||a.getAttribute("xlink:href");f.track(m,c);k&&"_blank"!==a.target&&!A(h)&&(C(h),
f._callback(function(){window.location.href=k}))})});return this};a.prototype.trackSubmit=a.prototype.trackForm=function(a,b,d){if(!a)return this;n.element(a)&&(a=[a]);var f=this;p(a,function(a){function h(m){C(m);m=n.fn(b)?b(a):b;var c=n.fn(d)?d(a):d;f.track(m,c);f._callback(function(){a.submit()})}if(!n.element(a))throw new TypeError("Must pass HTMLElement to `analytics.trackForm`.");var m=window.jQuery||window.Zepto;m?m(a).submit(h):t(a,"submit",h)});return this};a.prototype.page=function(a,b,
d,f,h){n.fn(f)&&(h=f,f=null);n.fn(d)&&(h=d,f=d=null);n.fn(b)&&(h=b,f=d=b=null);n.object(a)&&(f=b,d=a,b=a=null);n.object(b)&&(f=d,d=b,b=null);n.string(a)&&!n.string(b)&&(b=a,a=null);d=k(d)||{};b&&(d.name=b);a&&(d.category=a);var m=r();w(d,m);m=E(x(m),d);n.empty(m)||(f=f||{},f.context=f.context||{},f.context.page=m);m=this.normalize({properties:d,category:a,options:f,name:b});this._invoke("page",new K(m));this.emit("page",a,b,d,f);this._callback(h);return this};a.prototype.pageview=function(a){var b=
{};a&&(b.path=a);this.page(b);return this};a.prototype.alias=function(a,b,d,f){n.fn(d)&&(f=d,d=null);n.fn(b)&&(f=b,b=d=null);n.object(b)&&(d=b,b=null);var h=this.normalize({options:d,previousId:b,userId:a});this._invoke("alias",new H(h));this.emit("alias",a,b,d);this._callback(f);return this};a.prototype.ready=function(a){if(n.fn(a))if(this._readied)l.async(a);else this.once("ready",a);return this};a.prototype.timeout=function(a){this._timeout=a};a.prototype.debug=function(a){!arguments.length||a?
q.enable("analytics:"+(a||"*")):q.disable()};a.prototype._options=function(a){this.options=a=a||{};m.options(a.cookie);D.options(a.localStorage);z.options(a.user);v.options(a.group);return this};a.prototype._callback=function(a){l.async(a,this._timeout);return this};a.prototype._invoke=function(a,b){this.emit("invoke",b);p(this._integrations,function(d,f){b.enabled(d)&&f.invoke.call(f,a,b)});return this};a.prototype.push=function(a){var b=a.shift();this[b]&&this[b].apply(this,a)};a.prototype.reset=
function(){this.user().logout();this.group().logout()};a.prototype._parseQuery=function(a){function b(a,d){var f=a.length,h;return u(function(b,d,m){m.substr(0,f)===a&&(h=m.substr(f),b[h]=d);return b},{},d)}a=F.parse(a);var d=b("ajs_trait_",a),f=b("ajs_prop_",a);a.ajs_uid&&this.identify(a.ajs_uid,d);a.ajs_event&&this.track(a.ajs_event,f);a.ajs_aid&&z.anonymousId(a.ajs_aid);return this};a.prototype.normalize=function(a){a=B(a,x(this._integrations));a.anonymousId&&z.anonymousId(a.anonymousId);a.anonymousId=
...
b,d){a.hasOwnProperty(b)&&(a[b]=d);return a}function d(a){return a.replace(/[^a-zA-Z0-9\.]+/g,"").toLowerCase()}g.exports=a(function(a,b){if(a.hasOwnProperty(b))return a[b]});g.exports.find=g.exports;g.exports.replace=function(b,d,c,m){a(f).call(this,b,d,c,m);return b};g.exports.del=function(d,f,c){a(b).call(this,d,f,null,c);return d}},{}],43:[function(c,g,e){var a=c("is"),b=c("isodate"),f=c("./milliseconds"),d=c("./seconds");g.exports=function(h){if(a.date(h))return h;if(a.number(h)){var c=Date;
...
function(){var a=this.proxy("traits.company.created")||this.proxy("traits.company.createdAt");if(a)return d(a)};a.prototype.name=function(){var a=this.proxy("traits.name");if("string"===typeof a)return l(a);var a=this.firstName(),b=this.lastName();if(a&&b)return l(a+" "+b)};a.prototype.firstName=function(){var a=this.proxy("traits.firstName");if("string"===typeof a)return l(a);a=this.proxy("traits.name");if("string"===typeof a)return l(a).split(" ")[0]};a.prototype.lastName=function(){var a=this.proxy("traits.lastName");
if("string"===typeof a)return l(a);a=this.proxy("traits.name");if("string"===typeof a){var b=l(a).indexOf(" ");if(-1!==b)return l(a.substr(b+1))}};a.prototype.uid=function(){return this.userId()||this.username()||this.email()};a.prototype.description=function(){return this.proxy("traits.description")||this.proxy("traits.background")};a.prototype.age=function(){var a=this.birthday(),b=h(this.traits(),"age");if(null!=b)return b;if("date"==k(a))return(new Date).getFullYear()-a.getFullYear()};a.prototype.avatar=
...
a;if(a=this.discount())b+=a;return b};a.prototype.products=function(){var a=this.properties(),a=l(a,"products");return"array"==b(a)?a:[]};a.prototype.quantity=function(){return(this.obj.properties||{}).quantity||1};a.prototype.currency=function(){return(this.obj.properties||{}).currency||"USD"};a.prototype.referrer=f.proxy("properties.referrer");a.prototype.query=f.proxy("options.query");a.prototype.properties=function(a){var b=this.field("properties")||{};a=a||{};for(var d in a){var f=null==this[d]?
...
q[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function f(a,d){var c,h,e,g,l=k,q,t=d[a];t&&"object"===typeof t&&"function"===typeof t.toJSON&&(t=t.toJSON(a));"function"===typeof w&&(t=w.call(d,a,t));switch(typeof t){case "string":return b(t);case "number":return isFinite(t)?String(t):"null";case "boolean":case "null":return String(t);case "object":if(!t)return"null";k+=m;q=[];if("[object Array]"===Object.prototype.toString.apply(t)){g=t.length;
for(c=0;c<g;c+=1)q[c]=f(c,t)||"null";e=0===q.length?"[]":k?"[\n"+k+q.join(",\n"+k)+"\n"+l+"]":"["+q.join(",")+"]";k=l;return e}if(w&&"object"===typeof w)for(g=w.length,c=0;c<g;c+=1)"string"===typeof w[c]&&(h=w[c],(e=f(h,t))&&q.push(b(h)+(k?": ":":")+e));else for(h in t)Object.prototype.hasOwnProperty.call(t,h)&&(e=f(h,t))&&q.push(b(h)+(k?": ":":")+e);e=0===q.length?"{}":k?"{\n"+k+q.join(",\n"+k)+"\n"+l+"}":"{"+q.join(",")+"}";k=l;return e}}var d=g.exports={};"function"!==typeof Date.prototype.toJSON&&
(Date.prototype.toJSON=function(){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+a(this.getUTCMonth()+1)+"-"+a(this.getUTCDate())+"T"+a(this.getUTCHours())+":"+a(this.getUTCMinutes())+":"+a(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()});var c,e,k,m,q,w;"function"!==typeof d.stringify&&(e=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
q={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},d.stringify=function(a,b,d){var c;m=k="";if("number"===typeof d)for(c=0;c<d;c+=1)m+=" ";else"string"===typeof d&&(m=d);if((w=b)&&"function"!==typeof b&&("object"!==typeof b||"number"!==typeof b.length))throw Error("JSON.stringify");return f("",{"":a})});"function"!==typeof d.parse&&(c=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,d.parse=function(a,b){function d(a,
...
e.path);e.domain&&(g+="; domain="+e.domain);e.expires&&(g+="; expires="+e.expires.toUTCString());e.secure&&(g+="; secure");document.cookie=g;break;case 1:return a()[d];default:return a()}}},{debug:14}],16:[function(c,g,e){var a;try{a=c("@ndhoule/each")}catch(b){a=c("each")}g.exports=function(b,f,d){if("function"!==typeof b)throw new TypeError("Expected a function but received a "+typeof b);a(function(a,d,c){f=b(f,a,d,c)},d);return f}},{each:66}],66:[function(c,g,e){var a;try{a=c("@ndhoule/keys")}catch(k){a=
c("keys")}var b=Object.prototype.toString,f=function(a){var d=typeof a;return"number"===d||"object"===d&&"[object Number]"===b.call(a)},d="function"===typeof Array.isArray?Array.isArray:function(a){return"[object Array]"===b.call(a)},h=function(a,b){for(var d=0;d<b.length&&!1!==a(b[d],d,b);d+=1);},l=function(b,d){for(var f=a(d),c=0;c<f.length&&!1!==b(d[f[c]],f[c],d);c+=1);};g.exports=function(a,b){return(null!=b&&(d(b)||"function"!==b&&f(b.length))?h:l).call(this,a,b)}},{keys:67}],67:[function(c,
g,e){var a=String.prototype.charAt,b=function(b,d){return a.call(b,d)},f=Object.prototype.hasOwnProperty,d=Object.prototype.toString,h=function(a,b){return f.call(a,b)},l=function(a,b){b=b||h;for(var d=[],f=0,c=a.length;f<c;f+=1)b(a,f)&&d.push(String(f));return d};g.exports=function(a){if(null==a)return[];if("[object String]"===d.call(a))return l(a,b);if(null!=a&&"function"!==typeof a&&"number"===typeof a.length)return l(a,h);var f;f=h;var c=[],e;for(e in a)f(a,e)&&c.push(String(e));return c}},{}],
...
l(e,function(a){return a.toLowerCase()}),v=c.options||{},n=v.integrations||{},A=v.providers||{},x=v.context||{},y={};a("<-",c);f(v,function(a,b){g(a)&&(k.call(n,a)||(n[a]=b),delete v[a])});delete v.providers;f(A,function(a,b){g(a)&&(h.object(n[a])||k.call(n,a)&&"boolean"===typeof A[a]||(n[a]=b))});f(v,function(a){d(a,m)?y[a]=v[a]:x[a]=v[a]});delete c.options;y.integrations=n;y.context=x;y=b(y,c);a("->",y);return y};var m=["integrations","anonymousId","timestamp","context"]},{debug:14,defaults:15,
each:4,includes:72,is:18,"component/map":73}],72:[function(c,g,e){var a;try{a=c("@ndhoule/each")}catch(f){a=c("each")}var b=String.prototype.indexOf;g.exports=function(f,d){var c=!1;if("string"===typeof d)return-1!==b.call(d,f);a(function(a){a=a===f?0!==a||1/a===1/f:a!==a&&f!==f;if(a)return c=!0,!1},d);return c}},{each:66}],73:[function(c,g,e){var a=c("to-function");g.exports=function(b,f){var d=[];f=a(f);for(var c=0;c<b.length;++c)d.push(f(b[c],c));return d}},{"to-function":74}],74:[function(c,g,
...
{name:"analytics-core",version:"2.11.1",main:"analytics.js",dependencies:{},devDependencies:{}}},{}],3:[function(c,g,e){g.exports={"google-analytics":c("analytics.js-integration-google-analytics"),trekkie:c("../trekkie/integration/trekkie.js"),"reports-tracking":c("../trekkie/integration/reports-tracking.js"),performance:c("../trekkie/integration/performance.js")}},{"analytics.js-integration-google-analytics":80,"../trekkie/integration/trekkie.js":81,"../trekkie/integration/reports-tracking.js":82,
"../trekkie/integration/performance.js":83}],80:[function(c,g,e){function a(a,b){if(a){var d=a.path;b.includeSearch&&a.search&&(d+=a.search);return d}}function b(a){return!a||0>a?0:Math.round(a)}function f(a,b){for(var d=b.dimensions,c=b.metrics,f=n(c).concat(n(d)),e={},h=0;h<f.length;++h){var g=f[h],l=c[g]||d[g],g=w(a,g)||a[g];null!=g&&(e[l]=g)}return e}function d(a){var b=a.properties();window.ga("ec:addProduct",{id:a.id()||a.sku(),name:a.name(),category:a.category(),quantity:a.quantity(),price:a.price(),
brand:b.brand,variant:b.variant,currency:a.currency()})}function h(a,b,c){d(a);window.ga("ec:setAction",b,c||{})}function l(a){a=y([a.paymentMethod,a.shippingMethod],function(a){return a});return 0<a.length?a.join(", "):null}function k(a,b){b.currency=b.currency||a.currency();return new m({properties:b})}var m=c("facade").Track,q=c("defaults"),w=c("obj-case"),p=c("each"),u=c("analytics.js-integration"),v=c("is"),n=c("object").keys,A=c("object").length,x=c("global-queue")("_gaq"),y=c("select"),B=c("use-https"),
...
allowLinker:!0});a.doubleClick&&window.ga("require","displayfeatures");a.sendUserId&&t.id()&&window.ga("set","userId",t.id());a.anonymizeIp&&window.ga("set","anonymizeIp",!0);a=f(t.traits(),a);A(a)&&window.ga("set",a);this.load("library",this.ready)};r.prototype.loaded=function(){return!!window.gaplugins};r.prototype.page=function(b){var d=b.category(),c=b.properties(),e=b.fullName(),h=this.options,g=b.proxy("context.campaign")||{},l={},k=a(c,this.options),m=e||c.title;this._category=d;l.page=k;l.title=
m;l.location=c.url;g.name&&(l.campaignName=g.name);g.source&&(l.campaignSource=g.source);g.medium&&(l.campaignMedium=g.medium);g.content&&(l.campaignContent=g.content);g.term&&(l.campaignKeyword=g.term);c=f(c,h);A(c)&&window.ga("set",c);window.ga("set",{page:k,title:m});window.ga("send","pageview",l);d&&this.options.trackCategorizedPages&&(d=b.track(d),this.track(d,{nonInteraction:1}));e&&this.options.trackNamedPages&&(d=b.track(e),this.track(d,{nonInteraction:1}))};r.prototype.identify=function(a){var b=
...
x("_trackPageview",a(c,this.options));d&&this.options.trackCategorizedPages&&(d=b.track(d),this.track(d,{nonInteraction:1}));f&&this.options.trackNamedPages&&(d=b.track(f),this.track(d,{nonInteraction:1}))};r.prototype.trackClassic=function(a,d){var c=d||a.options(this.name),f=a.properties(),e=a.revenue(),h=a.event(),g=this._category||f.category||"All",l=f.label,e=b(e||f.value);x("_trackEvent",g,h,l,e,!(!f.nonInteraction&&!c.nonInteraction))};r.prototype.completedOrderClassic=function(a){var b=a.total()||
a.revenue()||0,d=a.orderId(),c=a.products()||[],f=a.properties(),e=a.currency();d&&(x("_addTrans",d,f.affiliation,b,a.tax(),a.shipping(),a.city(),a.state(),a.country()),p(c,function(a){a=new m({properties:a});x("_addItem",d,a.sku(),a.name(),a.category(),a.price(),a.quantity())}),x("_set","currencyCode",e),x("_trackTrans"))};r.prototype.loadEnhancedEcommerce=function(a){this.enhancedEcommerceLoaded||(window.ga("require","ec"),this.enhancedEcommerceLoaded=!0);window.ga("set","&cu",a.currency())};r.prototype.pushEnhancedEcommerce=
function(a){window.ga("send","event",a.category()||"EnhancedEcommerce",a.event(),{nonInteraction:1})};r.prototype.startedOrderEnhanced=function(a){this.viewedCheckoutStep(a)};r.prototype.updatedOrderEnhanced=function(a){this.startedOrderEnhanced(a)};r.prototype.viewedCheckoutStepEnhanced=function(a){var b=a.products(),c=a.properties(),f=l(c);this.loadEnhancedEcommerce(a);p(b,function(b){b=k(a,b);d(b)});window.ga("ec:setAction","checkout",{step:c.step||1,option:f||void 0});this.pushEnhancedEcommerce(a)};
...
{id:a.id(),name:a.name(),creative:b.creative,position:b.position});this.pushEnhancedEcommerce(a)};r.prototype.clickedPromotionEnhanced=function(a){var b=a.properties();this.loadEnhancedEcommerce(a);window.ga("ec:addPromo",{id:a.id(),name:a.name(),creative:b.creative,position:b.position});window.ga("ec:setAction","promo_click",{});this.pushEnhancedEcommerce(a)}},{facade:8,defaults:84,"obj-case":42,each:4,"analytics.js-integration":85,is:18,object:20,"global-queue":86,select:87,"use-https":88}],84:[function(c,
g,e){g.exports=function(a,b){for(var c in b)c in a||(a[c]=b[c]);return a}},{}],85:[function(c,g,e){var a=c("bind"),b=c("clone"),f=c("debug"),d=c("defaults"),h=c("extend"),l=c("slug"),k=c("./protos"),m=c("./statics");g.exports=function(c){function e(h){if(h&&h.addIntegration)return h.addIntegration(e);this.debug=f("analytics:integration:"+l(c));this.options=d(b(h)||{},this.defaults);this._queue=[];this.once("ready",a(this,this.flush));e.emit("construct",this);this.ready=a(this,this.ready);this._wrapInitialize();
this._wrapPage();this._wrapTrack()}e.prototype.defaults={};e.prototype.globals=[];e.prototype.templates={};e.prototype.name=c;h(e,m);h(e.prototype,k);return e}},{bind:89,clone:12,debug:90,defaults:15,extend:91,slug:92,"./protos":93,"./statics":94}],89:[function(c,g,e){var a=c("bind");c=c("bind-all");g.exports=e=a;e.all=c;e.methods=function(b,c){c=[].slice.call(arguments,1);for(var d=0,e;e=c[d];d++)b[e]=a(b,b[e]);return b}},{bind:55,"bind-all":56}],90:[function(c,g,e){g.exports="undefined"==typeof window?
c("./lib/debug"):c("./debug")},{"./lib/debug":95,"./debug":96}],95:[function(c,g,e){c=c("tty");g.exports=function(c){function e(){}function g(a){a=a instanceof Error?a.stack||a.message:a;var b=new Date,f=b-(d[c]||b);d[c]=b;b="  \u001b[9"+u+"m"+c+" \u001b[3"+u+"m\u001b[90m"+a+"\u001b[3"+u+"m +";f=36E5<=f?(f/36E5).toFixed(1)+"h":6E4<=f?(f/6E4).toFixed(1)+"m":1E3<=f?(f/1E3|0)+"s":f+"ms";a=b+f+"\u001b[0m";console.error.apply(this,arguments)}function w(a){a=a instanceof Error?a.stack||a.message:a;a=(new Date).toUTCString()+
" "+c+" "+a;console.error.apply(this,arguments)}e.enabled=!1;var p=b.some(function(a){return a.test(c)});if(p)return e;p=a.some(function(a){return a.test(c)});if(!p)return e;var u=f[h++%f.length];g.enabled=w.enabled=!0;return l||process.env.DEBUG_COLORS?g:w};var a=[],b=[];(process.env.DEBUG||"").split(/[\s,]+/).forEach(function(d){d=d.replace("*",".*?");"-"===d[0]?b.push(new RegExp("^"+d.substr(1)+"$")):a.push(new RegExp("^"+d+"$"))});var f=[6,2,3,4,5,1],d={},h=0,l=c.isatty(2)},{}],96:[function(c,
...
b+"$"))};a.disable=function(){a.enable("")};a.humanize=function(a){return 36E5<=a?(a/36E5).toFixed(1)+"h":6E4<=a?(a/6E4).toFixed(1)+"m":1E3<=a?(a/1E3|0)+"s":a+"ms"};a.enabled=function(b){for(var c=0,d=a.skips.length;c<d;c++)if(a.skips[c].test(b))return!1;c=0;for(d=a.names.length;c<d;c++)if(a.names[c].test(b))return!0;return!1};try{window.localStorage&&a.enable(localStorage.debug)}catch(b){}},{}],91:[function(c,g,e){g.exports=function(a){for(var b=Array.prototype.slice.call(arguments,1),c=0,d;d=b[c];c++)if(d)for(var e in d)a[e]=
d[e];return a}},{}],92:[function(c,g,e){g.exports=function(a,b){b||(b={});return a.toLowerCase().replace(b.replace||/[^a-z0-9]/g," ").replace(/^ +| +$/g,"").replace(/ +/g,b.separator||"-")}},{}],93:[function(c,g,e){function a(){}function b(a,b){b=b||function(){};var d=new Image;d.onerror=f(b,"failed to load pixel",d);d.onload=function(){b()};d.src=a.src;d.width=1;d.height=1;return d}function f(a,b,d){return function(c){c=c||window.event;var f=Error(b);f.event=c;f.source=d;a(f)}}function d(a,b){return q(function(a,
d,c){a[c]=d.replace(/\{\{\ *(\w+)\ *\}\}/g,function(a,d){return b[d]});return a},{},a.attrs)}g=c("emitter");var h=c("after"),l=c("each"),k=c("analytics-events"),m=c("fmt"),q=c("foldl"),w=c("load-iframe"),p=c("load-script"),u=c("to-no-case"),v=c("next-tick"),n=c("type"),A=Object.prototype.hasOwnProperty,x=window.onerror,y=window.setInterval,B=window.setTimeout;g(e);e.initialize=function(){v(this.ready)};e.loaded=function(){return!1};e.page=function(a){};e.track=function(a){};e.map=function(a,b){var d=
u(b);return q(function(a,b,c,f){if("array"===n(f)){if(!b.key)return a;c=b.key;b=b.value}u(c)===d&&a.push(b);return a},[],a)};e.invoke=function(a){if(this[a]){var b=Array.prototype.slice.call(arguments,1);if(!this._ready)return this.queue(a,b);var d;try{this.debug("%s with %o",a,b),d=this[a].apply(this,b)}catch(c){this.debug("error %o calling %s with %o",c,a,b)}return d}};e.queue=function(a,b){if("page"===a&&this._assumesPageview&&!this._initialized)return this.page.apply(this,b);this._queue.push({method:a,
args:b})};e.flush=function(){this._ready=!0;var a=this;l(this._queue,function(b){a[b.method].apply(a,b.args)});this._queue.length=0};e.reset=function(){for(var a=0;a<this.globals.length;a++)window[this.globals[a]]=void 0;window.setTimeout=B;window.setInterval=y;window.onerror=x;window.onload=null};e.load=function(c,f,e){"function"===typeof c&&(e=c,c=f=null);c&&"object"===typeof c&&(e=f,f=c,c=null);"function"===typeof f&&(e=f,f=null);c=c||"library";f=f||{};f=this.locals(f);var g=this.templates[c];
if(!g)throw Error(m('template "%s" not defined.',c));c=d(g,f);e=e||a;var h=this,k;switch(g.type){case "img":c.width=1;c.height=1;k=b(c,e);break;case "script":k=p(c,function(a){if(!a)return e();h.debug('error loading "%s" error="%s"',h.name,a)});delete c.src;l(c,function(a,b){k.setAttribute(a,b)});break;case "iframe":k=w(c,e)}return k};e.locals=function(a){a=a||{};var b=Math.floor((new Date).getTime()/36E5);a.hasOwnProperty("cache")||(a.cache=b);l(this.options,function(b,c){a.hasOwnProperty(b)||(a[b]=
...
{}],99:[function(c,g,e){function a(b){var c=[].slice.call(arguments,1),d=0;return b.replace(/%([a-z])/gi,function(b,e){return a[e]?a[e](c[d++]):b+e})}c=window.JSON?JSON.stringify:function(a){return String(a)};g.exports=a;a.o=c;a.s=String;a.d=parseInt},{}],100:[function(c,g,e){var a=c("script-onload"),b=c("next-tick"),f=c("type");g.exports=function(c,e){if(!c)throw Error("Cant load nothing...");"string"==f(c)&&(c={src:c});var g="https:"===document.location.protocol||"chrome-extension:"===document.location.protocol;
c.src&&0===c.src.indexOf("//")&&(c.src=g?"https:"+c.src:"http:"+c.src);g&&c.https?c.src=c.https:!g&&c.http&&(c.src=c.http);var k=document.createElement("iframe");k.src=c.src;k.width=c.width||1;k.height=c.height||1;k.style.display="none";"function"==f(e)&&a(k,e);b(function(){var a=document.getElementsByTagName("script")[0];a.parentNode.insertBefore(k,a)});return k}},{"script-onload":104,"next-tick":57,type:47}],104:[function(c,g,e){function a(a,b){a.addEventListener("load",function(a,c){b(null,c)},
!1);a.addEventListener("error",function(c){var e=Error('script error "'+a.src+'"');e.event=c;b(e)},!1)}function b(a,b){a.attachEvent("onreadystatechange",function(c){/complete|loaded/.test(a.readyState)&&b(null,c)});a.attachEvent("onerror",function(c){var e=Error('failed to load the script "'+a.src+'"');e.event=c||window.event;b(e)})}g.exports=function(c,d){return c.addEventListener?a(c,d):b(c,d)}},{}],101:[function(c,g,e){var a=c("script-onload"),b=c("next-tick"),f=c("type");g.exports=function(c,
...
{"script-onload":104,"next-tick":57,type:47}],102:[function(c,g,e){function a(a){return a.replace(h,function(a,b){return b?" "+b:""})}function b(a){return a.replace(l,function(a,b,c){return b+" "+c.toLowerCase().split("").join(" ")})}g.exports=function(c){return f.test(c)?c.toLowerCase():d.test(c)?a(c).toLowerCase():b(c).toLowerCase()};var f=/\s/,d=/[\W_]/,h=/[\W_]+(.|$)/g,l=/(.)([A-Z]+)/g},{}],94:[function(c,g,e){function a(a){a=a.replace(' src="',' data-src="');var c=b(a),e={};f(c.attributes,function(b){var c=
...
"</svg>"]},{}],86:[function(c,g,e){g.exports=function(a,b){b=b||{};return function(c){c=[].slice.call(arguments);window[a]||(window[a]=[]);!1===b.wrap?window[a].push.apply(window[a],c):window[a].push(c)}}},{}],87:[function(c,g,e){var a=c("to-function");g.exports=function(b,c){var d=[];c=a(c);for(var e=0;e<b.length;++e)c(b[e],e)&&d.push(b[e]);return d}},{"to-function":74}],88:[function(c,g,e){function a(){return"https:"==location.protocol||"chrome-extension:"==location.protocol}g.exports=function(b){switch(arguments.length){case 0:return a();
...
this._merge(a.properties(),{category:a.category(),name:a.name()});this.trekkie.emit("page",a)};c.prototype.alias=function(a){a={id:a.userId(),token:a.previousId()};this.trekkie.emit("alias",a)};c.prototype._merge=function(a,c){var d=function(a,b){for(var c in b)a[c]=b[c];return a},e=d({},a);return d(e,c)}},{"analytics.js-integration":85,"./../trekkie.js":106}],106:[function(c,g,e){function a(a,c){if(!a)throw"appName argument is required to initialize Trekkie.";this.appName=a;c=c?c:{};this.environment=
...
0;return("x"===a?b:b&3|8).toString(16)}).toUpperCase()},generateStrongUUID:function(a){var b=0;return"xxxxxxxx-xxxx-4xxx-xxxx".replace(/[x]/g,function(c){var f=a[b]%16;b++;return("x"===c?f:f&3|8).toString(16)}).toUpperCase()},build:function(){if(a.isEnabled())try{var b=window.crypto||window.msCrypto,c=new Uint16Array(19);b.getRandomValues(c);return f._uniqueId.generateStrongUUID(c)}catch(e){return f._uniqueId.generateWeakUUID()}else return"00000000-0000-0000-4000-000000000000"}},hasShortTerm:function(){return!!a.read("_shopify_s")||
!!a.read("_s")},hasLongTerm:function(){return!!a.read("_shopify_y")||!!a.read("_y")},shortTerm:function(){return f._uniqueId.fetchOrSet(!1)},longTerm:function(){return f._uniqueId.fetchOrSet(!0)}};e.visitToken=f.shortTerm;e.uniqToken=f.longTerm;e.hasUniqCookie=f.hasLongTerm;e.hasVisitCookie=f.hasShortTerm;e.buildUniqToken=f._uniqueId.build},{"./cookie.js":110,"./store.js":111}],110:[function(c,g,e){var a=c("cookie"),b=c("./utils.js"),f={read:function(b){return a(b)},writeForDomain:function(b,c,e,
...
e.read=f.read;e.write=f.write;e.shopifyCookieDomain=f.shopifyCookieDomain;e.isEnabled=f.isEnabled},{cookie:65,"./utils.js":112}],112:[function(c,g,e){e.startsWith=function(a,b){return 0===a.indexOf(b)}},{}],111:[function(c,g,e){var a={_storeType:function(a){a=a||{};return a.permanent?window.localStorage:window.sessionStorage},_isAvailable:function(a){try{a.setItem("t","t");var c=a.getItem("t");a.removeItem("t");return"t"===c}catch(d){return!1}},read:function(b,c){var d=a._storeType(c);return a._isAvailable(d)?
d.getItem(b):null},write:function(b,c,d){d=a._storeType(d);return a._isAvailable(d)?d.setItem(b,c):null}};e.read=a.read;e.write=a.write},{}],108:[function(c,g,e){var a=c("load-pixel")("https://v.shopify.com/:app/:type"),b=c("querystring").parse,f={load:function(b,c,e){return a(e,{app:b,type:c},f._error)},_error:function(c){if(c&&c.event===window.event){var f=c.source.src.split("?"),e=f[0].split(".com/")[1].split("/");c=e[0];var e=e[1],f=b(f[1]),g={};f.event&&(g.event=f.event);f.url&&(g.url=f.url);
g.truncated=!0;return a(g,{app:c,type:e})}}};e.load=f.load},{"load-pixel":113,querystring:27}],113:[function(c,g,e){function a(a,b,c){return function(f){f=f||window.event;var e=Error(b);e.event=f;e.source=c;a(e)}}var b=c("querystring").stringify,f=c("substitute");g.exports=function(c){return function(e,g,k){"function"==typeof g&&(k=g,g={});g=g||{};k=k||function(){};g=f(c,g);var m=new Image;m.onerror=a(k,"failed to load pixel",m);m.onload=function(){k()};(e=b(e))&&(e="?"+e);m.src=g+e;m.width=1;m.height=
1;return m}}},{querystring:27,substitute:114}],114:[function(c,g,e){g.exports=function(b,c,d){if(!c)throw new TypeError("expected an object");d=d||/:(\w+)/g;return b.replace(d,function(b,d){switch(a.call(c)){case "[object Object]":return null!=c[d]?c[d]:b;case "[object Array]":var e=c.shift();return null!=e?e:b}})};var a=Object.prototype.toString},{}],109:[function(c,g,e){var a={"Viewed Product":{resourceType:"product",pageType:"product"},"Added Product":{eventType:"add_to_cart",resourceType:"product",
pageType:"cart"},"Removed Product":{eventType:"remove_from_cart",resourceType:"product",pageType:"cart"},"Viewed Cart":{pageType:"cart"},"Cleared Cart":{eventType:"clear_cart",pageType:"cart"},"Viewed Product Category":{resourceType:"collection",pageType:"collection"},"Viewed Collections":{pageType:"collections"}};e.additionalParamsFromEvent=function(b){b=a[b];var c={},d;for(d in b)b.hasOwnProperty(d)&&(c[d]=b[d]);return c}},{}],82:[function(c,g,e){c=c("analytics.js-integration");g=g.exports=c("ReportsTracking").option("shopId",
...
function(){var b={},c;for(c in a)this.options.hasOwnProperty(c)&&this.options[c]&&(b[a[c]]=this.options[c]);window.__st=b;this.load(this.ready)};g.prototype.page=function(){}},{"analytics.js-integration":85}],83:[function(c,g,e){e=c("analytics.js-integration");var a=c("./../lib/perf.js");c=g.exports=e("Performance").option("navigationTimingApiMeasurementsEnabled",!1).option("navigationTimingApiMeasurementsSampleRate",.5);c.prototype.initialize=function(){this.ready()};c.prototype.page=function(b){b=
this._merge(b.properties(),{category:b.category(),name:b.name()});this.options.navigationTimingApiMeasurementsEnabled&&this.options.navigationTimingApiMeasurementsSampleRate>=Math.random()&&(b=this._merge(a.pagePerfomance(),b),this.analytics.track("navigation_performance_metrics",b))};c.prototype._merge=function(a,c){var d=function(a,b){for(var c in b)a[c]=b[c];return a},e=d({},a);return d(e,c)}},{"analytics.js-integration":85,"./../lib/perf.js":115}],115:[function(c,g,e){var a="navigationStart unloadEventStart unloadEventEnd redirectStart redirectEnd fetchStart domainLookupStart domainLookupEnd connectStart connectEnd secureConnectionStart requestStart responseStart responseEnd domLoading domInteractive domContentLoadedEventStart domContentLoadedEventEnd domComplete loadEventStart loadEventEnd".split(" ");
